...
const HistoryItem = props => (
  <View style={historyStyle.itemWrapper}>
    ...
    { props.active && !props.last && <LinearGradient colors={[colors.darkRed, colors.lightGrey]} style={[historyStyle.verticalLine, historyStyle.verticalLineActive]}/> }

    <View style={historyStyle.item}>
      <View style={historyStyle.header}>
        {!props.active && <View style={historyStyle.ruler}/>}

        <Text style={[historyStyle.timeElapsed, historyStyle.time, props.active && historyStyle.timeActive]}>
          {
            props.active
        ...
        <Text style={[historyStyle.timeFromNow, historyStyle.time, props.active && historyStyle.timeActive]}>
      ...
      <View style={historyStyle.carWrapper}>
        <View style={[historyStyle.dot, props.active && historyStyle.dotActive]}>
          {props.active && <View style={historyStyle.innerDotActive} />}
        </View>
